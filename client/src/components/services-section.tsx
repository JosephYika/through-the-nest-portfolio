      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {services.map((service) => (
            <div 
              key={service.id}
              className={`service-card bg-white dark:bg-gray-700 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 fade-in group hover:scale-[1.02] ${
            ...
            >
              ...
              <div className="text-center border-t border-gray-200 dark:border-gray-600 pt-6">
                ...
                <button 
                  ...
                  className="w-full bg-soft-gold hover:bg-yellow-600 text-white font-semibold py-3 px-6 rounded-full transition-all duration-300"
                >
                  Book Session
                </button>
              </div>
